...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Note: GET /api/agency/projects/:id and PATCH /api/agency/projects/:id 
  // are now handled by agency.ts domain router
...
<body>
  ...
  // Note: GET /api/client/objectives is now handled by client.ts domain router
  ...
  // Note: GET /api/agency/messages is now handled by agency.ts domain router
