...
// Note: Proposal print endpoint is registered in server/routes.ts before requireAuth middleware
// This allows token-based auth via query params for popup windows
// ============================================================================
// PROPOSAL SECTIONS
// ============================================================================
