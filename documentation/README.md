...
| Document | Purpose |
|----------|---------|
| [Architecture](./ARCHITECTURE.md) | System design, diagrams, Intelligence Core, multi-tenancy |
| [Technical Brief](./TECHNICAL_BRIEF.md) | Implementation patterns, API contracts, code examples |
| [Priority List](./PRIORITY_LIST.md) | Roadmap, priorities, technical debt register |
| [Maintenance Matrix](./maintenance-matrix.md) | Module health scores, cleanup queue |
| [Frontend-Backend Map](./frontend-backend-map.md) | React → API → Storage mapping |
