...
- **Routes Decomposition** 🔄 - Phase 2 in progress: 10 routers mounted (109 routes), ~40 routes pending extraction, cross-tenant protection enforced
...
- Domain Routers (mounted): 82 🟢 ← auth, user, client, agency, staff, crm, settings, superadmin, invoices (109 routes)
- Workflow Engine: 79 🟡
