...
- **Routes Decomposition** 🔄 - Phase 2 in progress: 9 routers mounted (103 routes), ~46 routes pending extraction, cross-tenant protection enforced
...
- Domain Routers (mounted): 82 🟢 ← auth, user, client, agency, staff, crm, settings, superadmin (103 routes)
- Workflow Engine: 79 🟡
