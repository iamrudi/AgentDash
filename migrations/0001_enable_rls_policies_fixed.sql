...
-- ================================================================
-- HELPER FUNCTIONS (in public schema to avoid permission issues)
-- ================================================================
...
TO authenticated
WITH CHECK (user_id = auth.uid() OR public.get_agency_id() IS NOT NULL);
...
COMMENT ON FUNCTION public.get_agency_id() IS 'Extracts agency_id from Supabase Auth JWT app_metadata for RLS policies';
COMMENT ON FUNCTION public.is_authenticated() IS 'Checks if current user is authenticated via Supabase Auth';
